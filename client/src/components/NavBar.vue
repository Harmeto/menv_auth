  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="appNavbar">
      ...
      <ul class="navbar-nav mb-2 mb-lg-0">
        ...
        <template v-else>
          <li class="nav-item">
            <router-link class="nav-link" :to="{name: 'login'}" aria-current="page">Login</router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link" :to="{name: 'register'}" aria-current="page">Register</router-link>
          </li>
        </template>
      </ul>
    </div>
